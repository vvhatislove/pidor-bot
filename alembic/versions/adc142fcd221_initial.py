...
Revision ID: adc142fcd221
Revises: 
Create Date: 2025-07-19 13:32:05.157822
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('status', sa.Enum('WAITING_FOR_CONFIRMATION', 'ACTIVE', 'FINISHED', 'CANCELLED', name='duelstatus'), nullable=False),
