"""add balance, skills, user skills, duel win chances

Revision ID: 2519079d30f9
Revises: 
Create Date: 2025-05-29 14:38:02.228932
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'ACTIVE', 'FINISHED', 'CANCELLED', name='duelstatus'), nullable=False),
